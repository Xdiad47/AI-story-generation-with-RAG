...
export default async function AdminStoryPage({ params }: { params: { id: string } }) {
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8 w-full bg-white dark:bg-zinc-950 shadow-2xl rounded-3xl my-8 border border-zinc-100 dark:border-zinc-800">
      <nav className="mb-8 pl-4">
        <Link href="/admin" className="inline-flex items-center gap-2 text-zinc-500 hover:text-terracotta transition-colors font-medium">
